...
if ($ADMIN->fulltree) {
    ...
    if (!function_exists('ldap_connect')) {
        ...
        // Only positive integral seconds (with no leading zeros) are allowed for the connection timeout.
        $settings->add(new admin_setting_configtext_trim_lower('enrol_ldap/connecttimeout', get_string('connecttimeout_key', 'enrol_ldap'), get_string('connecttimeout', 'enrol_ldap'), 0, false, true, PARAM_INT));
